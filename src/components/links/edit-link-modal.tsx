...
interface EditLinkModalProps {
  ...
  link: Link | null
  onSubmit: (id: string, data: Partial<Link>) => Promise<{ success: boolean; error?: string }>
}

export function EditLinkModal({ open, onOpenChange, link, onSubmit }: EditLinkModalProps) {
  ...
  const handleSubmit = async (data: FormData) => {
    ...
    const result = await onSubmit(link.id, linkData)
